        ...
        <section id="about" className="min-h-screen flex items-center justify-center py-20">
            <RevealOnScroll>
                    <div className="max-w-3xl mx-auto px-4">
                        ...
                        <div className="rounded-xl p-8 border-white/10 border hover:-translate-y-1 transition-all hover:shadow-[0_0_24px_rgba(142,60,210,0.35)] hover:border-purple-600/30">
                        ...
                        <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all mt-6 hover:shadow-[0_0_24px_rgba(142,60,210,0.35)] hover:border-purple-600/30">
