        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-purple-600/30 hover:shadow-[0_0_24px_rgba(142,60,210,0.35)] transition-all">
                ...
                <div className="flex justify-between items-center">
                    <a href="https://github.com/Calum29d/Typerzz" className="text-purple-600 hover:text-purple-500 transistion-colors my-4">View Project &rarr;</a>
                </div>
            </div>
            ...
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-purple-600/30 hover:shadow-[0_0_24px_rgba(142,60,210,0.35)] transition-all">
                ...
                <div className="flex justify-between items-center">
                    <a href="https://github.com/Calum29d/MyPortfolio" className="text-purple-600 hover:text-purple-500 transistion-colors my-4">View Project &rarr;</a>
                </div>
            </div>
        </div>               
        </div>
